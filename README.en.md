...
- [OPEN_SOURCE_RELEASE.en.md](OPEN_SOURCE_RELEASE.en.md): release notes for this open source publication.
- [RELEASE.en.md](RELEASE.en.md): formal release runbook.
...
Central publication must follow [RELEASE.en.md](RELEASE.en.md). The default flow only uploads to Sonatype Central Portal for manual review. Do not publish automatically to Maven Central without explicit maintainer approval.
